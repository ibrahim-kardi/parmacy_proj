 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>    
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-building-o"></i>&nbsp;Please Add your Company Name </h1>
            <p>Your Company Name Page ..</p>
          </div>
          <div>
            <ul class="breadcrumb">
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2">
          	<div class="card">
				...
				<i class="fa fa-plus"></i>&nbsp;Add Company Name</b></h3>		
							...
							<div class="table-responsive">  
								<table class="table table-bordered" id="dynamic_field"> 
									...
									<tr>  
										...
										<td><button type="button" name="add" id="add" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Add More</button></td>  
									</tr>  
								</table> 
        ...
        <div class="row">
          ...
          <h3 class="card-title text-center"><b>
				<i class="fa fa-building-o"></i>&nbsp;Company Name</b></h3>	
              <div class="card-body">
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
       <div class="modal-header">
        ...
        <i class="fa fa-pencil-square"></i>&nbsp;&nbsp;Update Company Name</h4>
      </div>
      <div class="modal-body">
        <div class="form-group">
			<label class="control-label col-md-3 text-right">Company Name</label>
			<div class="col-md-9">
